...
const EditBlogAttachFileCard = (props) => {

        const { AttatchmentFilesState, inputAttatchmentFiles, setinputAttatchmentFiles, save, saveDisabled } = props
                ...
                <div className="w3-container w3-card w3-white w3-round w3-margin">
                    ...
                    <div className="w3-container w3-margin">
                        <ul className="w3-ul w3-card-4 file_card">
                            ...
                            {AttatchmentFilesState.map(file =>
...
export default EditBlogAttachFileCard;