...
const AskQuestionAttachFileCard = (props) => {
    const { inputAttatchmentFiles, setinputAttatchmentFiles, Ask} =props
        ...
        <>
            ...
            <div className="w3-container w3-card w3-white w3-round w3-margin">
                ...
                <div className="w3-container">
                    <button onClick={Ask} className="w3-rest w3-theme-d2 w3-right w3-button w3-round" style={{ marginLeft: 25, alignSelf: "end", display: "flex", justifyContent: "center", alignItems: "center" }}>
                        Ask
                    </button>
                </div>
...
export default AskQuestionAttachFileCard;