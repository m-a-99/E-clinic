const DoctorProfileGeneralCard = (props) => {
    const {work_phone_number,  email, gender, about_me, specialization, years_of_experience } = props.general;
        return (
...
export default DoctorProfileGeneralCard;